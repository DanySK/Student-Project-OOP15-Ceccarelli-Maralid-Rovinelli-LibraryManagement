...
public interface EmployeesModel {
   /**
    *This method updates the map of employees.
    *This method takes as input a map of employee.
    * 
    * @param employees
    */
    ...
    /**
     * this method search in the list an employee and return true or false if exsist or not
     * 
     * @param username
     * @param password
